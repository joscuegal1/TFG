...
public class Competitor__5 {
    ...
    private List<Player__2> players = null;
    @JsonProperty("qualifier")
    private String qualifier;
    @JsonProperty("statistics")
    private Statistics__7 statistics;
    ...
    @JsonProperty("players")
    public void setPlayers(List<Player__2> players) {
    ...
    @JsonProperty("statistics")
    public Statistics__7 getStatistics() {
        return statistics;
    }

    @JsonProperty("statistics")
    public void setStatistics(Statistics__7 statistics) {
