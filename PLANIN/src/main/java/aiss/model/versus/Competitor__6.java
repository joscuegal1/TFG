...
public class Competitor__6 {
    ...
    private List<Player__3> players = null;
    @JsonProperty("qualifier")
    private String qualifier;
    @JsonProperty("statistics")
    private Statistics__9 statistics;
    ...
    @JsonProperty("statistics")
    public Statistics__9 getStatistics() {
        return statistics;
    }

    @JsonProperty("statistics")
    public void setStatistics(Statistics__9 statistics) {
