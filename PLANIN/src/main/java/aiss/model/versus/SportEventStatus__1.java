...
public class SportEventStatus__1 {
    ...
    private List<BallLocation__1> ballLocations = null;
    @JsonProperty("clock")
    private Clock__1 clock;
    ...
    private MatchSituation__1 matchSituation;
    @JsonProperty("match_status")
    private String matchStatus;
    @JsonProperty("match_tie")
    private Boolean matchTie;
    @JsonProperty("period_scores")
    private List<PeriodScore__1> periodScores = null;
    ...
    @JsonProperty("ball_locations")
    public List<BallLocation__1> getBallLocations() {
        return ballLocations;
    }

    @JsonProperty("ball_locations")
    public void setBallLocations(List<BallLocation__1> ballLocations) {
        this.ballLocations = ballLocations;
    }

    @JsonProperty("clock")
    public Clock__1 getClock() {
        return clock;
    }

    @JsonProperty("clock")
    public void setClock(Clock__1 clock) {
        this.clock = clock;
    }
    ...
    @JsonProperty("match_situation")
    public MatchSituation__1 getMatchSituation() {
        return matchSituation;
    }

    @JsonProperty("match_situation")
    public void setMatchSituation(MatchSituation__1 matchSituation) {
    ...
    @JsonProperty("period_scores")
    public List<PeriodScore__1> getPeriodScores() {
        return periodScores;
    }

    @JsonProperty("period_scores")
    public void setPeriodScores(List<PeriodScore__1> periodScores) {
